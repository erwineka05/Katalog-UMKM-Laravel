...
<body class="bg-white">
    ...
    <header x-data="{ sidebarOpen: false }" class="bg-white shadow-sm sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="text-2xl font-bold text-gray-800">Katalog<span class="bg-green-600 text-white text-xs font-semibold px-2 py-1 rounded-full ml-1">Umbulharjo </span></div>
            ...
            <a href="#" class="hidden md:block bg-green-600 text-white px-5 py-2 rounded-md font-semibold hover:bg-green-700">Kontak Kami</a>
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                <h2 class="text-3xl font-bold text-white mb-2">Katalog Umbulharjo</h2>
                <p class="text-gray-400 mb-6">Pusat Informasi Digital Umbulharjo, Cangkringan, Sleman</p>
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <span>Jl. Kaliurang KM 20, Umbulharjo, Cangkringan, Sleman, Yogyakarta</span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span>@umkm_umbulharjo_jogja</span>
                    </div>
                </div>
            </div>
...
<div class="bg-slate-900 text-gray-400 text-center text-sm py-4">
    &copy; {{ date('Y') }} Katalog Umbulharjo. All Rights Reserved.
</div>
</body>
</html>