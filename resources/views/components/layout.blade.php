            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        class="hover:text-green-400 hover:underline break-words text-sm">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="https://wa.me/6287731728778" target="_blank" class="hover:text-green-400 hover:underline text-sm">
                            +62 877-3172-8778
                        </a>
                    </div>
                    <div class="flex items-center">
                        ...
                        target="_blank"
                        class="hover:text-green-400 hover:underline text-sm">
                        @kalikuningbrand
                    </a>
                    </div>
                    <div class="flex items-center">
                        ...
                        <a href="mailto:kalikuningbrandumbulharjo@gmail.com" class="hover:text-green-400 hover:underline text-sm min-w-0 overflow-hidden whitespace-nowrap text-ellipsis">
                            kalikuningbrand@gmail.com
                        </a>
                    </div>
                </div>
            </div>
